...
// if you want to edit language file with HMR make isDev true and set DEFAULT_LOCALE
...
i18n.init({
  ...
  lng: isDev ? DEFAULT_LOCALE : undefined, // language to use, more information here: https://www.i18next.com/overview/configuration-options#languages-namespaces-resources
